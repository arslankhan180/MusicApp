        ...
        <>
            ...
            >
                <div className='search__head'>
                    ...
                    <button type='button' className='btn btn-sm btn-light-primary'>{sidebar('artists')}</button>
                    <button type='button' className='btn btn-sm btn-light-primary'>{locale('songs')}</button>
                    ...
                    <div className='search__body'>
                        <div className='mb-4'>
                            <div className='d-flex align-items-center justify-content-between mb-3'>
                                ...
                                <Link href='/music/artist' className='btn btn-link'>{locale('view_all')}</Link>
                            </div>
                        ...
                        <div className='mb-4'>
                            <div className='d-flex align-items-center justify-content-between mb-3'>
                                ...
                                <Link href='/music/song' className='btn btn-link'>{locale('view_all')}</Link>
                            </div>
                            <div className='row g-4 list'>
                                <div className='col-xl-3 col-md-4 col-sm-6'>
                                    <div className='list__item'>
